...
<body>
    ...
    <section id="orders" class="dashboard-section">
        ...
        <table>
            ...
            <tbody>
                <?php
                $stmt = $conn->query("SELECT o.*, u.username as customer_name, p.name as product_name 
                                    FROM orders o 
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    echo "<tr>
                        ...
                        <td>
                            ...
                            <a href='AdminDashboard.php?delete=1&type=order&id={$row['id']}'><button>Delete</button></a>
                        </td>
                    </tr>";
                }
                ?>
