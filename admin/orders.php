...
$ordersStmt = $pdo->query("SELECT o.*, c.name as customer_name, c.email as customer_email 
    FROM orders o
...
foreach ($orders as $order) {
    ...
    $orderItemCounts[$order['order_id']] = $result['count'];
}
...
<head>
    ...
    <title>Order Management - GLOBAL HARDWARE Store</title>
...
<body>
    ...
    <main class="main-content">
        <header class="top-header">
            <div class="header-greeting">
                <div class="greeting-text">Order Management</div>
                <div class="greeting-subtitle">Manage and track all customer orders efficiently.</div>
            </div>
        </header>
        ...
        <div class="container">
            ...
            <?php if (isset($_GET['info'])): ?>
                <div class="info" style="background: rgba(59, 130, 246, 0.1); color: #93c5fd; border-left-color: #3b82f6;"><?= htmlspecialchars($_GET['info']) ?></div>
            <?php endif; ?>
            ...
            <?php if (empty($orders)): ?>
                <p style="color: var(--text-secondary); padding: 40px; text-align: center;">No orders found.</p>
            <?php else: ?>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $orderItemCounts[$order['order_id']] ?? 0 ?> item(s)</td>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a href="order_view.php?id=<?= $order['order_id'] ?>" class="view-link">View Details</a>
                                        <form action="order_process.php" method="POST" style="display:inline;" onsubmit="return confirmStatusChange(this)">
                                            <input type="hidden" name="order_id" value="<?= $order['order_id'] ?>">
                                            <select name="status" onchange="this.form.submit()" style="padding: 6px 12px; font-size: 13px; background: var(--card-bg); border: 1px solid var(--border-color); border-radius: 6px; color: var(--text-primary);">
    ...
    <script>
        function confirmStatusChange(form) {
            ...
            const confirmed = confirm(`Are you sure you want to change order #${orderId} status to "${newStatus}"?`);
