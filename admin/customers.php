...
// Fetch all customers
$customersStmt = $pdo->query("SELECT * FROM customers ORDER BY created_at DESC");
$customers = $customersStmt->fetchAll();

// Get order count for each customer
$customerOrders = [];
foreach ($customers as $customer) {
    $countStmt = $pdo->prepare("SELECT COUNT(*) as count FROM orders WHERE customer_id = ?");
    $countStmt->execute([$customer['customer_id']]);
    $result = $countStmt->fetch();
    $customerOrders[$customer['customer_id']] = $result['count'];
}
?>
<!DOCTYPE html>
<html>
<head>
    <title>Customer Management - GLOBAL HARDWARE Store</title>
    <meta charset="UTF-8">
    ...
    <main class="main-content">
        <header class="top-header">
            <div class="header-greeting">
                <div class="greeting-text">Customer Management</div>
                <div class="greeting-subtitle">Manage your customers and their information efficiently.</div>
            </div>
        </header>
        <div class="container">
        ...
        <div class="form-section">
            <h2>Add New Customer (Manual Registration)</h2>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <a href="customer_orders.php?id=<?= $customer['customer_id'] ?>" class="view-orders">
                        <?= $customerOrders[$customer['customer_id']] ?? 0 ?> order(s)
                    </a>
                </td>
                <td>
                ...
                <td>
                    <div class="action-buttons">
                        <a href="customer_edit.php?id=<?= $customer['customer_id'] ?>">
                            <button>Edit</button>
                        </a>
                        <form action="customer_process.php" method="POST">
                        ...
                        <form action="customer_process.php" method="POST" onsubmit="return confirm('Are you sure you want to delete this customer? This will also delete all their orders.');">
