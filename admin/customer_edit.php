...
<head>
    ...
    <title>Edit Customer - GLOBAL HARDWARE Store</title>
...
<body>
    ...
    <div class="main-content">
        <div class="top-header">
            ...
            <p class="header-subtitle">Update customer information and account settings</p>
        </div>
        ...
        <div class="content-area">
            <div class="form-container">
                <div class="form-header">
                    ...
                    <p class="form-subtitle">Modify the customer information below</p>
                </div>
                ...
                <form action="customer_edit_process.php" method="POST">
                    ...
                    <div class="form-group">
                        <label>Address</label>
                        <textarea name="address" rows="4" placeholder="Enter customer address"><?= htmlspecialchars($customer['address'] ?? '') ?></textarea>
                    </div>
                    
                    <div class="form-group">
                        <label>Change Password</label>
                        <input type="password" name="password" placeholder="Leave blank to keep current password">
                        <div class="password-note">Only fill this field if you want to change the customer's password</div>
                    </div>
