...
// Fetch currently assigned suppliers
$currentSuppliersStmt = $pdo->prepare("SELECT supplier_id FROM product_supplier WHERE product_id = ?");
$currentSuppliersStmt->execute([$productId]);
$currentSuppliers = $currentSuppliersStmt->fetchAll(PDO::FETCH_COLUMN);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Edit Product - GLOBAL HARDWARE Store</title>
...
<body>
    ...
    <div class="main-content">
        <div class="top-header">
            ...
            <p class="header-subtitle">Update product information and settings</p>
        </div>
        ...
        <div class="content-area">
            <div class="form-container">
                <div class="form-header">
                    ...
                    <p class="form-subtitle">Modify the product information below</p>
                </div>
                ...
                <form action="product_edit_process.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" rows="4" placeholder="Enter product description"><?= htmlspecialchars($product['description']) ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="image-preview">
                            <?php if (!empty($product['image'])): ?>
                                ...
                                <div class="image-info">Current: <?= htmlspecialchars($product['image']) ?></div>
                            <?php else: ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="image-info">Select a new image file (JPG, PNG, GIF - Max 5MB). Leave empty to keep current image.</div>
                        ...
                        <select name="suppliers[]" multiple>
                            <?php foreach($allSuppliers as $supplier): ?>
                                <option value="<?= $supplier['supplier_id'] ?>" 
                                    <?= in_array($supplier['supplier_id'], $currentSuppliers) ? 'selected' : '' ?>>
                                    <?= htmlspecialchars($supplier['name']) ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                        <div class="image-info">Hold Ctrl/Cmd to select multiple suppliers</div>
                    </div>
